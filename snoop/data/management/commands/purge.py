...
class Command(BaseCommand):
    ...
    def handle(self, **options):
        ...
        print(len(collections.get_all()),
              'collections in "liquid.ini": ',
              ', '.join(collections.get_all().keys()))

        es_indexes = set(indexing.all_indices())
        active_indexes = set(c.es_index for c in collections.get_all().values())
        ...
        active_dbs = set(c.db_name for c in collections.get_all().values())
        ...
        active_buckets = set(c.name for c in collections.get_all().values())
