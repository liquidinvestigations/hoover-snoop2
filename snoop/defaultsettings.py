...
TABLES_SPLIT_FILE_ROW_COUNT = 20000
...
SNOOP_S3FS_MOUNT_LIMIT = int(os.getenv('SNOOP_S3FS_MOUNT_LIMIT', '5'))
...
ENABLE_DYNAMIC_COLLECTION_ADMINS = bool(os.getenv('ENABLE_DYNAMIC_COLLECTION_ADMINS', None))
